                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="siege"
                                                                placeholder="Entrez votre siège" value="Ouagadougou" />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
