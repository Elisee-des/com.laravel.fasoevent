                                                        ...
                                                        <div class="row flex-grow">
                                                            <div
                                                                ...
                                                                <div class="auth-form-transparent text-left p-3">
                                                                    ...
                                                                    <h4>New here?</h4>
                                                                    <h6 class="font-weight-light">Join us today! It
                                                                        takes only few steps</h6>
                                                                    <form class="pt-3">
                                                                        <div class="form-group">
                                                                            <label>Username</label>
                                                                            <div class="input-group">
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        <i
                                                                                            class="mdi mdi-account-outline text-primary"></i>
                                                                                    </span>
                                                                                </div>
                                                                                <input type="text"
                                                                            ...
                                                                            <div class="input-group">
                                                                                <div
                                                                                    ...
                                                                                    <span
                                                                                        class="input-group-text bg-transparent border-right-0">
                                                                                        <i
                                                                                            class="mdi mdi-lock-outline text-primary"></i>
                                                                                    </span>
                                                                                </div>
                                                                                <input type="password"
                                                                                    class="form-control form-control-lg border-left-0"
